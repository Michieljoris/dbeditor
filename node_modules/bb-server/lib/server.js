...
StaticServlet.prototype.handleRequest = function(req, res) {
    ...
    // });
    // console.log('0 doing fstat on:' + req.url.pathname);
...
exports.createServer = function (someOptions) {
    ...
    if (options.sessions) {
        // var opts = {};
        // if (options.sessions.expires) opts.expires = options.sessions.expires;
        // if (options.sessions.domain) opts.domain = options.sessions.domain;
        // if (options.sessions.path) opts.path = options.sessions.path;
